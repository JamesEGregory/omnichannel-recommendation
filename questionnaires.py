...
DIAGNOSTIC = [
    {
        "id": "demand",
        "text": "Approximate daily contact volume (all channels)",
        "type": "select",
        "options": ["<50/day", "50–200/day", "200–1000/day", "1000+/day"]
    },
    {
        "id": "agents",
        "text": "Approximate number of contact centre agents",
        "type": "select",
        "options": ["<20", "20–100", "100–300", "300+"]
    },
    {
        "id": "structure",
        "text": "How are your contact centre teams structured?",
        "type": "select",
        "options": ["Single central centre", "Multiple departmental teams", "Mixed", "Not sure"]
    },
    {
        "id": "strategy",
        "text": "Top strategic drivers (pick up to 3)",
        "type": "multiselect",
    ...
    {
        "id": "automation",
        "text": "Automation ambition over the next 3 years",
        "type": "select",
    ...
    {
        "id": "hand_off",
        "text": "Is seamless hand-off between channels required?",
        "type": "select",
        "options": ["Yes", "No", "Not sure"]
    },
    {
        "id": "integration",
        "text": "Integration maturity",
        "type": "select",
        "options": ["Manual/siloed", "Point-to-point", "Middleware/APIs", "Mature integration platform"]
    },
    {
        "id": "back_office",
        "text": "Priority back-office systems to integrate (free text)",
        "type": "text"
    },
    {
        "id": "telephony",
        "text": "Current telephony platform",
        "type": "select",
        "options": ["Avaya", "Cisco", "Mitel", "Teams Voice", "8x8", "RingCentral", "Other/Unknown"]
    },
    {
        "id": "crm",
        "text": "Current CRM/case management system",
        "type": "select",
        "options": ["Dynamics 365", "Salesforce", "Netcall Liberty", "Civica", "Capita ONE", "ServiceNow", "None/Unknown"]
    },
    {
        "id": "lock_in",
        "text": "How important is avoiding dependency on a single vendor/platform?",
        "type": "select",
        "options": ["Not a concern", "Somewhat important", "Very important"]
    },
    {
        "id": "procurement",
        "text": "Commercial model preference",
        "type": "select",
        "options": ["Subscription (per agent/month)", "Consumption (pay per use)", "CapEx", "No preference"]
    },
    {
        "id": "delivery",
        "text": "Preferred delivery approach",
        "type": "select",
        "options": ["Turnkey vendor", "Hybrid (partner + in-house)", "Open platform we control"]
    },
    {
        "id": "budget",
        "text": "Indicative budget (run + change)",
        "type": "select",
        "options": ["Low (<£50k)", "Medium (£50k–£150k)", "High (£150k+)"]
    }
]
